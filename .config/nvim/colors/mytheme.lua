...
-- KIVA section
hi('String', {fg = '#ffae32'})
--hi('Pmenu',  { fg = "#000000", bg = '#ffffff',   ctermfg = 'Black', ctermbg = 'White', reverse=false })
hi('Pmenu',  { fg = "#ffffff", bg = '#111114',   ctermfg = 'White', ctermbg = 'White', reverse=false })
...
--hi("Number", {fg = "#aef527"})
--hi("Type", {fg = "#ffc847"})
--hi("Statement", {fg = "#ffc847"})
--hi("Function", {fg = "#27f350"})
